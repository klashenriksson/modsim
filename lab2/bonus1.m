...
for i = 1:rho_iters
    ...
    g10_2_i = init_graph(g10_2,rho,initial_infect_fract);
    g10_3_i = init_graph(g10_3,rho,initial_infect_fract);
    g10_4_i = init_graph(g10_4,rho,initial_infect_fract);
    
    g10_2_i = stoch_sim_over_network(g10_2_i, mu,beta, 0, t_end, iters*10, "Lockdown", "Group");
    g10_3_i = stoch_sim_over_network(g10_3_i, mu,beta, 0, t_end, iters, "Lockdown", "Group");
    g10_4_i = stoch_sim_over_network(g10_4_i, mu,beta, 0, t_end, iters, "Lockdown", "Group");
